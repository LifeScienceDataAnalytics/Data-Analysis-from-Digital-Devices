...
def set_settings(f,opts):
    ...
    template = '--epochs 500 --model_name model_HIVAE_inputDropout --restore 0 --train 1         --data_file data_python/INPUT_FILE.csv --types_file data_python/TYPES_FILE          --batch_size NBATCH --save 499 --save_file INPUT_FILE        --dim_latent_s 1 --dim_latent_z 1 --dim_latent_y YDIM         --miss_percentage_train 0 --miss_percentage_test 0         --true_miss_file data_python/MISS_FILE --learning_rate LRATE --weight_decay WDECAY'
