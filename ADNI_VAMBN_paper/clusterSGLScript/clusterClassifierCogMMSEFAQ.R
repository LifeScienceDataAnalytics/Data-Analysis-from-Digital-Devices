...
##load feature list
featureDesc =read_delim("~/Altoida_VAMBN_paper/ALTOIDA/....csv", ";", escape_double = FALSE, col_names = TRUE, trim_ws = TRUE)
...
save.image("~/ADNI_VAMBN_paper/workspaces/paramDigMMSE.Rdata")