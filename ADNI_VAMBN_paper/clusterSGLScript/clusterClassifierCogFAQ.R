...
Class = "Class"
type = "CogFAQ"
paramCogFAQ = func.classifier.sgl(adniClassifierMCItoDementiaCogFAQ, index = index, type = type, "Class")
save.image("~/ADNI_VAMBN_paper/workspaces/paramCogFAQMCItoDem.RData")