...
indexDigMMSEFAQ_only = func.classifier.sgl.best.param(adniClassifierCNtoMCIDigMMSEFAQ_only, index = indexDigMMSEFAQ_only, type = type, "Class")
save.image("paramCogMMSEFAQ_only.RData")