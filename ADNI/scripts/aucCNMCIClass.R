...
library(PRROC)
library(stringr)
load("~/Documents/Documents_IT/paper/ADNI_VAMBN_paper/resultsSGLCNMCI_upd.RData")
...
#load("~/Documents/Documents_IT/paper/ADNI_VAMBN_paper/resultsSGLCNMCI.RData")
#load("~/Documents/Documents_IT/paper/ADNI_VAMBN_paper/aucCNMCIClass_50.RData")
##run auc function again
##CogMMSEFAQ
...
# names(boxplotDf) = c( "MMSE", "FAQ", "MMSEFAQ","Digital cognitive domains", "MMSE, FAQ and Digital cognitive domains",
#                       "MMSE, FAQ and Digital tasks")
...
png("sgl_R/plots_revised/AUC_boxplot_adni_cnmci_upd.png", width = 200, height = 150, units='mm',res = 300) 
...
png("sgl_R/plots_revised/F1_boxplot_adni_cnmci_upd.png", width = 200, height = 150, units='mm',res = 300) 
...
save.image("~/Documents/Documents_IT/paper/ADNI_VAMBN_paper_final/aucSGLCNMCI.RData")
