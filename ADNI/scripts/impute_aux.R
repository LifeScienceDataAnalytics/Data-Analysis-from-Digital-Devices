...
# data_all$stalone_VIS1_rs$`SA_Calpastatin-calpain_subgraph_rs10053056_VIS1` = factor(data_all$stalone_VIS1_rs$`SA_Calpastatin-calpain_subgraph_rs10053056_VIS1`)
# data_all$stalone_VIS1_rs$`SA_Beta-Catenin_subgraph_rs1543332_VIS1`= factor(data_all$stalone_VIS1_rs$`SA_Beta-Catenin_subgraph_rs1543332_VIS1`)
# data_all$stalone_VIS1_rs$`SA_Beta-Oxidation_of_Fatty_Acids_pathway_rs6444175_VIS1`= factor(data_all$stalone_VIS1_rs$`SA_Beta-Oxidation_of_Fatty_Acids_pathway_rs6444175_VIS1`)
data_aux=list()
