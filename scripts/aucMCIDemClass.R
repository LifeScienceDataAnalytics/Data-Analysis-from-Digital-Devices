...
load("~/ADNI_VAMBN_paper/workspaces/resultsSGLMCIDem.RData")
...
png("~/ADNI_VAMBN_paper/sgl_R/plots/AUC_boxplot_adni_mciDem.png", width = 300, height = 200, units='mm',res = 300) 
...
save.image("~/ADNI_VAMBN_paper/workspaces/aucSGLMCIDem.RData")  
